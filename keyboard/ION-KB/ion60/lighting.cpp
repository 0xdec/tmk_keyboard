...
static const uint8_t group_map[NUM_GROUPS][24] PROGMEM = {
    ...
    {0x41,0x44,0x4A,0x4D,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80}
};
...
void backlight_send_group(uint8_t group) {
    ...
    for (uint8_t i = 0; i < 24; i++) {
        ...
        if ((col & 0xF0) == 0xF0) {
            // Lock key LED
            TLC.set(i, lock_leds[col & 0x0F] * brightness);
        } else if (col != 0x80) {
